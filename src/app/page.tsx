...
export default function DashboardPage() {
  ...
  const cards = [
    {
      ...
      href: "/planning/training-plan", // Updated href to match our structure
    ...
    },
    {
      ...
      href: "/planning/athletes", // Updated href to match our structure
    ...
    },
    {
      ...
      href: "/training/workout-results", // Updated href to match our structure
  ...
  return (
    <div className="container mx-auto p-6">
      {" "}
      {/* Removed outer space-y from previous version */}
      ...
      <div className="mt-16 p-6 bg-gradient-to-r from-indigo-500/90 to-purple-600/90 rounded-lg shadow-sm hover:shadow-lg hover:bg-gradient-to-r hover:from-indigo-600/90 hover:to-purple-700/90 transition-all duration-300 cursor-pointer text-white">
        ...
        >
          <Link href="/training/assistant-coach">
            {/* Updated href */}Try Assistant Coach →
          </Link>
        </Button>
      </div>
    </div>
