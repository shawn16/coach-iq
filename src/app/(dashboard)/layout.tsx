  ...
  const routes = [
    {
      heading: "PLANNING",
      links: [
        { href: "/training-plan", label: "Training Plan", icon: <ClipboardList className="h-5 w-5 text-indigo-500" /> },
        {
    ...
    },
    {
      ...
      links: [
        ...
        { href: "/workout-results", label: "Workout Results", icon: <BarChart3 className="h-5 w-5 text-rose-500" /> },
        { href: "/athletes", label: "Athletes", icon: <Users className="h-5 w-5 text-amber-500" /> },
        { href: "/assistant-coach", label: "Assistant Coach", icon: <Zap className="h-5 w-5 text-cyan-500" /> },
      ],
    },
    {
      heading: "PERFORMANCE",
      links: [
        { href: "/team-leaderboard", label: "Team Leaderboard", icon: <Trophy className="h-5 w-5 text-yellow-500" /> },
        { href: "/create-race-plan", label: "Create Race Plan", icon: <Flag className="h-5 w-5 text-red-500" /> },
      ],
    },
    {
      heading: "SETTINGS",
      links: [
        { href: "/settings", label: "Settings", icon: <Settings className="h-5 w-5 text-slate-500" /> },
        { href: "/about", label: "About", icon: <Info className="h-5 w-5 text-gray-500" /> },
      ],
    },
  ]
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      >
        ...
        >
          <ThemeToggle />
          {!collapsed && <span className="text-xs text-gray-500 dark:text-gray-400">v1.0.0</span>}
        </div>
      </div>
